...
So that your program can run safely and successfully on the ISS, there are some requirements it needs to meet. If you've worked through this guide, then your program should already be fine. However, as a final step before you submit your entry, you should double-check that:
...
Your program is documented and easy to understand. There is no attempt to hide or make difficult to understand what a piece of code does.
